...
function bhela_seo_description() {
	...
	if ( is_page() ) {
		$map = array(
			...
			'booking-guide' => 'টাঙ্গুয়ার হাওরে হাউসবোট বুক করার আগে যা জানা জরুরি — নিরাপত্তা, কেবিন, খাবার, রুট ও রেট যাচাইয়ের সম্পূর্ণ গাইড। Tanguar Haor houseboat booking guide.',
